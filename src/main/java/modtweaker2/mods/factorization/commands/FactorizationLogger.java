        ...
        if (!validArguments.containsAll(args)) {
            ...
            if (args.isEmpty() || args.contains("Crystallizer")) {
                for (Object recipe : FactorizationHelper.crystallizer) {
                    MineTweakerAPI.logCommand(
                            String.format(
                                    "mods.factorization.Crystallizer.addRecipe(%s, %s, %s, %s);",
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "input")),
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "output")),
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "solution")),
            ...
            if (args.isEmpty() || args.contains("Lacerator")) {
                for (Object recipe : FactorizationHelper.lacerator) {
                    MineTweakerAPI.logCommand(
                            String.format(
                                    "mods.factorization.Lacerator.addRecipe(%s, %s, %s);",
                                    ReflectionHelper.<String>getObject(recipe, "oreName") != null
                                            ? LogHelper.getStackDescription(
                                                    ReflectionHelper.<String>getObject(recipe, "oreName"))
                                            : LogHelper.getStackDescription(
                                                    ReflectionHelper.<ItemStack>getObject(recipe, "itemstack")),
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "output")),
            ...
            if (args.isEmpty() || args.contains("SlagFurnace")) {
                for (Object recipe : FactorizationHelper.slag) {
                    MineTweakerAPI.logCommand(
                            String.format(
                                    "mods.factorization.SlagFurnace.addRecipe(%s, %s, %s, %s, %s);",
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "input")),
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "output2")),
                                    ReflectionHelper.<Float>getObject(recipe, "prob2"),
                                    LogHelper.getStackDescription(
                                            ReflectionHelper.<ItemStack>getObject(recipe, "output1")),
